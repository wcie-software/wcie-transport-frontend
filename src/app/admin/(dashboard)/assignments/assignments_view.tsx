...
const MapView = dynamic(() => import(
	"@/app/admin/(dashboard)/assignments/map_view"),
	{ ssr: false } // Don't pre-render on server because it uses "window"
);

export default function AssignmentsView({ requestsList, driversList, routes }: {
	...
	return (
		<div className="relative w-full h-full text-white">
			<div className="max-w-lg absolute top-0 right-0 m-4 flex flex-row gap-2 justify-between items-center z-[500]">
