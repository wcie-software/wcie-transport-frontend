...
export default function PrimaryButton({ id, type = "button", disabled = false, outline = false, onClick, children }:
	...
	return (
		<button
			...
			type={type}
			className={clsx(
				"px-8 py-3 min-h-0 flex items-center justify-center text-white rounded cursor-pointer disabled:cursor-not-allowed truncate",
				{
					"bg-primary disabled:bg-gray-500": !outline,
